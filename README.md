...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/spymicmac-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13289&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/spymicmac-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `spymicmac` can be installed with:

```
conda install spymicmac
```

It is possible to list all of the versions of `spymicmac` available on your platform with:
